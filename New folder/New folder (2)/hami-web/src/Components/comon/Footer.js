...
function Footer() {
    return (
    <>
            <footer style={{ backgroundColor: 'darkgray', marginTop: '20px' }} className="page-footer font-small indigo  bg-light">
                {/* Footer Links */}
                <div className="container">
                    ...
                    <div className="row pb-3">
                        ...
                        <div className="col-md-12">
                            <div style={{ justifyContent: 'center', textAlign: 'center' }} className="mb-5 flex-center">
                                {/* Facebook */}
                                <a className="fb-ic">
